...
class Network():
    ...
    def initialize(self):
        ...
        # Define network
        self.policy_function, self.value_function = self.define_network(self.state)

        output_evaluated = tf.reduce_sum(self.policy_function * self.actions, axis=[1])
    ...
    def acc_gradients_p(self, action, state):
        # accumulate gradients wrt policy weights
        pass

    def acc_gradients_v(self, state):
        # accumulate gradients wrt value weights
        pass
